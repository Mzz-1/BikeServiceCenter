...
namespace BikeServiceCenter.Data
{
    ...
    public static class UsersService
    {
        ...
        // Gets the data of all the verified users in the system and stores it in a json file
        ...
        // Gets the data of all the verified users in the system and returns them in a list
        ...
        // Method to store the data of a new user added by the admin
        ...
        // Creates the default admin for the system on the first execution of the program
        ...
        // Method to delete the data of a user 
        ...
        // Method to log a user in the system after validating their details 
